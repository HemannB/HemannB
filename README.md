...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=2DB329&center=true&vCenter=true&random=true&width=435&lines=Hey%2C+I'm+Bruno+%F0%9F%91%8B%F0%9F%8F%BB)](https://git.io/typing-svg)

![Profile views](https://komarev.com/ghpvc/?username=HemannB&color=64748b&style=flat&label=profile+views)

</div>

---

I got into tech because I wanted to build things — not just use them.  
From sensor wiring and firmware to APIs and dashboards — I like understanding every layer of what I ship.

> *"The work reveals the craftsman. Everything else is noise."*

---

```
├── Software Engineering Intern @ VORLE Tecnologia e Inovação
├── CS student @ URI — Santiago, RS
...
<details open>
  <summary><h2>🛠️ What I build with</h2></summary>
  ...
  ![Avalonia](https://img.shields.io/badge/Avalonia-8B5CF6?style=flat-square&logoColor=white)
  ![SDL2](https://img.shields.io/badge/SDL2-1C1C1C?style=flat-square&logoColor=white)
...
<details open>
  ...
  <h3>💨 AirSniffer — full-stack air quality monitoring system</h3>

  > Hardware, firmware, and software. Built from scratch.
